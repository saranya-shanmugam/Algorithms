...
public class StringCompression {
	...
	private void getCompressedString(String str1) {
		...
		// We can initialize StringBuilder to its necessary capacity up-front.
		// Without this, StringBuilder will (behind the scenes) need to double
		// its capacity every time it hits capacity. The capacity could be
		// double what we ultimately need.
		StringBuilder compressedString = new StringBuilder(str1.length());
	...
	/**
	 * Returns true if a character appears more than once in the given string so
	 * that the string will be compressed.
	 * 
	 * @param str1
	 * @return
	 */
